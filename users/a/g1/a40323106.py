...
a40323106 = Blueprint('a40323106', __name__, url_prefix='/a40323106', template_folder='templates')
...
@a40323106.route('/circle')
def drawcircle():
    return head_str + chain_str + circle(0, 0) + tail_str
 
 
@a40323106.route('/circle1/<degree>', defaults={'x': 0, 'y': 0})
@a40323106.route('/circle1/<x>/<degree>', defaults={'y': 0})
@a40323106.route('/circle1/<x>/<y>/<degree>')
#@a40323106.route('/circle1/<int:x>/<int:y>/<int:degree>')
def drawcircle1(x,y,degree):
    return head_str + chain_str + circle1(int(x), int(y), int(degree)) + tail_str
 
 
@a40323106.route('/circle2/<degree>', defaults={'x': 0, 'y': 0})
@a40323106.route('/circle2/<x>/<degree>', defaults={'y': 0})
@a40323106.route('/circle2/<x>/<y>/<degree>')
#@a40323106.route('/circle2/<int:x>/<int:y>/<int:degree>')
def drawcircle2(x,y,degree):
    return head_str + chain_str + circle2(int(x), int(y), int(degree)) + tail_str
 
 
@a40323106.route('/twocircle/<x>/<y>')
@a40323106.route('/twocircle', defaults={'x':0, 'y':0})
def drawtwocircle(x,y):
    return head_str + chain_str + twocircle(int(x), int(y)) + tail_str
 
 
@a40323106.route('/eighteenthirty/<x>/<y>')
@a40323106.route('/eighteenthirty', defaults={'x':0, 'y':0})
def draweithteenthirdy(x,y):
    return head_str + chain_str + eighteenthirty(int(x), int(y)) + tail_str
 
 
@a40323106.route('/snap')
